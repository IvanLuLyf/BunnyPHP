        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
            ...
            <div class="postcard">
                <div class="postcard-title">
                    <div class="pull-left">
                        <img class="img-responsive img-circle img-avatar"
                             src="api.php?mod=user&action=getavatar&username=<?php echo $post['username']; ?>">
                    </div>
                ...
                <?php foreach ($comments as $comment) : ?>
                    <div class="postcard">
                        <div class="postcard-title">
                            <div class="pull-left">
                                <img class="img-responsive img-circle img-avatar"
                                     src="api.php?mod=user&action=getavatar&username=<?php echo $comment['username']; ?>">
                            </div>
                            <div class="postcard-info">
